...
ifdef KLTE_MARSHMALLOW
	TARGET_PREBUILT_KERNEL := device/samsung/kltekdi/zImage-M
	TARGET_PREBUILT_DTB := device/samsung/kltekdi/dtb.img-M
else
	TARGET_PREBUILT_KERNEL := device/samsung/kltekdi/zImage-L
	TARGET_PREBUILT_DTB := device/samsung/kltekdi/dtb.img-L
endif
